...
def mp_game_setup(game, bot_skill: int = 0):
    ...
    if bot_skill == 0:
        # easy bots
        game.add_game_args(f"+viz_bots_path /Users/mahdikhashan/tmp/doom-drl/doom_arena/bots/easy.cfg")
    if bot_skill == 1:
        pass
    if bot_skill >= 2:
        # hard bots
        game.add_game_args(f"+viz_bots_path /system/user/fpaische/jku.wad/doom_arena/scenarios/doom_arena/bots/hard.cfg")
    return game
...
class VizdoomMPEnv(Env):
    ...
    def __init__(
        self,
        config_path: str = "/Users/mahdikhashan/tmp/doom-drl/doom_arena/scenarios/jku.cfg",
        ...
        if config_path == "/Users/mahdikhashan/tmp/doom-drl/doom_arena/scenarios/jku.cfg":
